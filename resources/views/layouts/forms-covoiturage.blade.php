...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#components-nav" href="{{ route("reserver") }}">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Covoiturage</li>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label class="col-sm-4 col-form-label">Compagnie</label>
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example">
                      <option selected>Gare voyageur</option>
                    </select>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" id="prix" class="form-control disabled" aria-label="Amount (to the nearest dollar)">
