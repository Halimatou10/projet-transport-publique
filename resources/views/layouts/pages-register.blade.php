                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">svp, entrez un email valid!</div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <div class="invalid-feedback">Svp, Choisssez un nom d'utiisateur.</div>
                      </div>
                    </div>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" required>
                      <div class="invalid-feedback">Svp, saisissez à nouveau votre mot de passe</div>
                    </div>

                    <div class="col-12">
                      <label for="inputNumber" class="col-sm-4 col-form-label">Photo</label>
                      <div class="col-sm-10">
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Avez-vous déjà un compte? <a href="{{ route('login') }}">Se Connecter</a></p>
                    </div>
                  </form>
