...
<head>
  ...
  <title>Pages / Contact - TransPub</title>
          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Addresse</h3>
                <p>Nord-Cifan,<br>Ngaoundéré, Cameroun</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Appel</h3>
                <p>+237 658 220 819<br>+237 678 653 935</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
                ...
                <h3>Email</h3>
                <p>alaminedahle@gmail.com<br>abdoulazis@gmail.com</p>
              </div>
            </div>
            <div class="col-lg-6">
              <div class="info-box card">
            ...
            <form action="forms/contact.php" method="post" class="php-email-form">
              <div class="row gy-4">
                ...
                <div class="col-md-12 text-center">
                  ...
                  <div class="sent-message">Votre message a été envoyé. Merci bien!</div>
