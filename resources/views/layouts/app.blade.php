...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" href="geo.html">
                <i class="bi bi-geo-alt"></i><span>Géolocalisation</span><i class="bi ms-auto"></i>
            </a>
        </li><!-- End Components Nav -->

        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#components-nav" href="pages-contact.html">
...
<section id="hero" class="d-flex justify-content-center align-items-center section">
    <div class="row">
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            ...
            <a href="components-carousel.html" class="btn-get-started">Réserver</a>
        </div>
    </div>
</section><!-- End Hero -->
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <img src="assets/img/locomotive.jpg" class="img-fluid" alt="">
                </div>
